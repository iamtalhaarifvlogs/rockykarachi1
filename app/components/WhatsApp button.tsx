...
export default function WhatsAppButton() {
  const phoneNumber = "923708540579"; // Pakistan format without +
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <Link
        ...
        target="_blank"
        className="group flex items-center bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg transition-all duration-300 overflow-hidden"
      >
        {/* Icon */}
        <div className="p-4">
          <svg
        ...
        {/* Hover Text */}
        <span className="max-w-0 group-hover:max-w-xs transition-all duration-300 whitespace-nowrap overflow-hidden pr-5 text-sm font-medium">
          Chat on WhatsApp
        </span>
      </Link>
    </div>
